...
public class UtilityFunctions {
    public static void uploadProfileImage(final StorageReference storageRef, Uri uri, final CoordinatorLayout layout, final ProgressBar progressBar, final DatabaseReference databaseRef, final String userId) {
